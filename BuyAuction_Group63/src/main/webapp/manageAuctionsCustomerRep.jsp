...
<h3>View All Auctions</h3>
	...
	try {
		...
		tempwinner = " ";
			...
			out.print("<td>");
			out.print("<form action='removeBids.jsp' method='post'><button name='auction_id' type='submit' value='"
			+ result.getInt("auction_id") + "'>Remove Bid</button></form>");
			out.print("</td>");
